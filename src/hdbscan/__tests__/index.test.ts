...
describe('HDBSCAN', () => {
  ...
  test('should correctly cluster simple 2D data', () => {
    const data = [
      [1, 1], [1.5, 1], [1, 1.5],[1.2,1.1] ,// Cluster 1
      [5, 5], [5.65, 4.87], [5.12, 5.59], [4.9,5.6], // Cluster 2
      [3, 3],                       // Noise point
    ];

    const hdbscan = new HDBSCAN({ minClusterSize: 3, minSamples: 2, debugMode });
    hdbscan.fit(data);
  ...
  test('should handle different dimensional data', () => {
    const data3D = [
     [1, 1.9, 1], [1.3, 1, 1.1], [1.5, 1.2, 1],[1.7, 1.3, 1],
          [30, 39, 30], [33, 30, 31], [35, 32, 30],[37, 33, 30],
        [100, 100, 100], [102, 100, 100], [100, 101, 100], [102, 101, 100],
    ];
